...
public static class GanttDataProvider {
    ...
    public static Task CreateTask(string id, string parentid, string subject, string start, string end, string percent, string type, string status, string resources, string description) {
        var task = new Task();
        task.ID = id;
